...
def get_github_commits(detail_type="all",num_commits=5,GITHUB_USERNAME = "abhirajsingh1234",REPO_NAME = "Llama-usage-raw-and-optimized",BRANCH_NAME = "main"):
    # GitHub API URL
    ...
    if response.status_code == 200:
        ...
        return f"Error fetching commits: on {GITHUB_USERNAME}/{REPO_NAME} check if the repository exists and you have the correct permissions."
